...
Base planner cu:
http://wiki.ros.org/base_planner_cu

Navigation stack:
http://wiki.ros.org/navigation

Navigation robot setup:
http://wiki.ros.org/navigation/Tutorials/RobotSetup

Navigation robot setup with transforms:
...
Turtlebot3 actions:
http://wiki.ros.org/turtlebot_actions?distro=kinetic
...
Human Aware Navigation Paper:
http://ais.informatik.uni-freiburg.de/publications/papers/kollmitz15ecmr.pdf

Human Aware Navigation stack git:
https://github.com/marinaKollmitz/human_aware_navigation

Human Aware Navigation Stack global planner:
https://github.com/marinaKollmitz/lattice_planner

Human Aware Navigation Stack local planner:
https://github.com/marinaKollmitz/timed_path_follower

gazebo_msgs::ModelStates docs:
http://docs.ros.org/jade/api/gazebo_msgs/html/msg/ModelStates.html

People_msgs::people docs:
http://docs.ros.org/api/people_msgs/html/msg/People.html
